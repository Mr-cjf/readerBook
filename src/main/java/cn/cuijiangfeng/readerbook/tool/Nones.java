package cn.cuijiangfeng.readerbook.tool;
...
public final class Nones {
    ...
    private static final String NOT_NULL_OR_EMPTY = "The parameter must not be null or empty!";
    ...
    public static void requireNonEmpty(Object[] array) {
        if (isEmpty(array)) {
            throw new IllegalArgumentException(NOT_NULL_OR_EMPTY);
        }
    }
